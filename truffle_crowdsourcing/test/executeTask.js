...
{ 
    ...
    it("Test time of executeTask...", function() 
    {
        ...
        {
            timer(PC.executeTask, "0x78bb4db7484ef49b836d90c37f45ea12a11bccbc", "0xd072b812a49f3c6ccbda896118bbca70f018a1934aac6175899970aad6cd6aa2", 654513, "0xf40392bd6a8866ccc46651971b5313a2d3c28f03cf33143ff80c80f955df8ea8", "0xf40392bd6a8866ccc46651971b5313a2d3c28f03cf33143ff80c80f955df8ea8", 0x39e0702d2eba7a7106e8746d76fa0ad26fb1847a1699f785be6d5f7ad75e8185, N);

            function timer(fn, a, b, c, d, e, f, total) 
            {
                i = 0;
                while(i < total)
                {
                    myDate1[i] = new Date().getTime();
                    fn(a,b,c,d,e,f).then(function(hash)
                    {
